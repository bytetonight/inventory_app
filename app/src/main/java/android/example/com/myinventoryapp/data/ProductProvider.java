...
public class ProductProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.virtual.warehouse/products" will map to the
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case PRODUCT_ID:
                ...
                // For an example URI such as "content://com.virtual.warehouse/products/3",
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link ProductEntry#COLUMN_PRODUCT_TARGET_GENDER} key is present,
        // check that the gender value is valid.
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_TARGET_GENDER)) {
            Integer gender = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_TARGET_GENDER);
            if (gender == null || !ProductEntry.isValidTargetGender(gender)) {
                throw new IllegalArgumentException("Product requires valid target_gender");
            }
        }
